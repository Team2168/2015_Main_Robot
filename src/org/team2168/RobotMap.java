...
public class RobotMap {
	...
	public static final int liftEncoderMinRate = 0;
	...
	public static final double LIFT_OVER_CURRENT_LOWER = 35.0; //amps
	public static final double LIFT_STALL_PERIOD = 0.3; //seconds stall can be sustained for
	public static final double LIFT_STALL_RATE = 12.5; //inches/sec
