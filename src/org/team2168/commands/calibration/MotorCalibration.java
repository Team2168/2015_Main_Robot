    ...
    protected void execute() {
    	if (motorNumber == RobotMap.DRIVETRAIN_LEFT_MOTOR_1) {
    		...
    		if ( !(((lastEncoderValue - Robot.drivetrain.getLeftPosition()) > 0) && (oscillatingValue > 0))) {
    			...
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_LEFT_MOTOR_1);
    		lastEncoderValue = Robot.drivetrain.getLeftPosition();
    	}
    	if (motorNumber == RobotMap.DRIVETRAIN_LEFT_MOTOR_2) {
    		Robot.drivetrain.driveLeft2(oscillatingValue);
    		if ( !(((lastEncoderValue - Robot.drivetrain.getLeftPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_LEFT_MOTOR_2);
    		}else if (!((lastEncoderValue - Robot.drivetrain.getLeftPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_LEFT_MOTOR_2);
    		lastEncoderValue = Robot.drivetrain.getLeftPosition();
    	...
    	if (motorNumber == RobotMap.DRIVETRAIN_LEFT_MOTOR_3) {
    		...
    		if ( !(((lastEncoderValue - Robot.drivetrain.getLeftPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_LEFT_MOTOR_3);
    		}else if (!((lastEncoderValue - Robot.drivetrain.getLeftPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_LEFT_MOTOR_3);
    		lastEncoderValue = Robot.drivetrain.getLeftPosition();
    	...
    	if (motorNumber == RobotMap.DRIVETRAIN_RIGHT_MOTOR_1) {
    		...
    		if ( !(((lastEncoderValue - Robot.drivetrain.getRightPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_1);
    		}else if (!((lastEncoderValue - Robot.drivetrain.getRightPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_1);
   
    		lastEncoderValue = Robot.drivetrain.getRightPosition();
    		
    	}
    	if (motorNumber == RobotMap.DRIVETRAIN_RIGHT_MOTOR_2) {
    		Robot.drivetrain.driveRight2(oscillatingValue);
     		if ( !(((lastEncoderValue - Robot.drivetrain.getRightPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_2);
    		}else if (!((lastEncoderValue - Robot.drivetrain.getRightPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_2);
    	...
    	if (motorNumber == RobotMap.DRIVETRAIN_RIGHT_MOTOR_3) {
    		Robot.drivetrain.driveRight3(oscillatingValue);
     		if ( !(((lastEncoderValue - Robot.drivetrain.getRightPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_3);
    		}else if (!((lastEncoderValue - Robot.drivetrain.getRightPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.DRIVETRAIN_RIGHT_MOTOR_3);
    	...
    	if (motorNumber == RobotMap.LIFT_MOTOR) {
    		...
    		if ( !(((lastEncoderValue - Robot.lift.getPosition()) > 0) && (oscillatingValue > 0))) {
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.INTAKE_RIGHT_MOTOR);
    		}else if (!((lastEncoderValue - Robot.lift.getPosition() < 0) && (oscillatingValue < 0)))
    			System.out.println("Encoder or Motor not working. PWM Channel : " + RobotMap.INTAKE_RIGHT_MOTOR);
    		
    		lastEncoderValue = Robot.lift.getPosition();
