 ...
 *
 */
public class Auto_ThreeToteRollingBinRide extends CommandGroup {
    
    public  Auto_ThreeToteRollingBinRide() {
    	...
    	addSequential(new LiftPIDPosition(34, 1), 1.4);
    	...
    	addSequential(new DriveXDistance(6.5, 0.3), 2.5); //drive slow to move bin
    	...
    	addSequential(new DriveXDistance(7, 0.3),2.0); //drive slow to move bin
    	//addSequential(new DriveXDistance(3, 0.3),4); //drive slow to move bin
