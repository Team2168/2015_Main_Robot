 ...
 */
public class Auto_RCCB_Slow extends CommandGroup {
    
    public  Auto_RCCB_Slow() { 
    	
    	addSequential(new DriveXDistance(-2.5, 1, 0.2), 3.5); //hight setpoint for full speed drive
