...
/**
 * The purpose of this command is to stop the controller at the target
 * distance, or if an object is detected with the IR sensor, which ever comes
 * first.
 * @author kharrila
 *
 */
public class DriveXDistanceUntilObject extends Command{
	 ...
	 */
	public DriveXDistanceUntilObject(double distance) {
	...
	public DriveXDistanceUntilObject(double distance, double speed) {
		this(distance);
		this.speed = speed;
	}

	public DriveXDistanceUntilObject(double distance, double speed, double powerShift) {
		this(distance, speed);
