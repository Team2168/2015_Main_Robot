...
public class FalconClaw {
	...
	// The entries labeled 'minDriveSpeed' should be tweaked based on your drivetrain.
	 ...
	 * @param joystickScale the scaling profile. A sorted (ascending) set of input/output pairs.
	 *   Where X values are the input joystick value, and Y values are the adjusted value
	 */
	...
	/**
	 * Create a new FalconClaw, providing josytick information for later use.
	 * Using the default joystick scaling profile
	 * @param port the port the joystick is on
	 * @param speedChannel the axis to monitor for acceleration
	 * @param brakeChannel the axis to monitor for braking
	 */
	...
	/**
	 * Create a new FalconClaw, providing joystick information for later use, and your own scaling profile.
	 * @param port the port the joystick is on
	 * @param speedChannel the axis to monitor for acceleration
	 * @param brakeChannel the axis to monitor for braking
	 * @param minDriveSpeed the value sent to the drivetrain motor controllers which begin motion
	 * @param joystickScale the scaling profile. A sorted (ascending) set of input/output pairs.
	 *   Where X values are the input joystick value, and Y values are the adjusted value
	 */
	...
	/**
	 * Electronic braking - aka "Falcon Claw" The more the "brake" is pulled,
	 * the slower output speed.
	 *
	...
	public double getAdjustedValue() {
		//TODO: write
		//for use when a joystick port and axis channels were provided in the constructor.
		return 0.0;
	}
